...
@section('title', 'Tambah Point Check')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Tambah Point Check</div>
            </div>
        </div>

        <div class="section-body">
            <form action="{{ route('point_check.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('nama_point_check') is-invalid @enderror"
                                        id="nama_point_check" placeholder="Masukan Point Check" name="nama_point_check" value="{{ old('nama_point_check') }}" autocomplete="off">
